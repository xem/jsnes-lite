...
// NB: if the indirect vector falls on a page boundary ($xxFF), it will wrap and fetch the low byte in the same page ($xx00)
// Addressings: abs, ind
// Opcodes:     4C,  6C
// Cycles:      3,   5
// Cycles addr: 1,   3
// Cycles opc:  0,   2
+ `o>76&&(a=r(a)+256*r(a+1-256*(!0&a))),PC=a-1 `
